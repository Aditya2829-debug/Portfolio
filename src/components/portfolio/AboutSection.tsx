export default function AboutSection() {
  return (
    <section id="about" className="py-20 px-4">
      ...
      <div className="absolute top-1/3 left-10 w-64 h-64 rounded-full border border-border/30 animate-float" />
      ...
      <div className="container mx-auto max-w-4xl relative">
        ...
        <div className="glass-bright rounded-3xl p-12 xl:p-16 gradient-border-bright hover-glow hover-lift transition-all duration-500 animate-scale-in">
