# Aditya Srivastava Developer Portfolio Requirements Document
...
- 3D tilt effects on glass cards on hover
- Magnetic cursor effect on interactive elements
- Animated gradient text for headings
- Floating navigation dots with section indicators
- Reveal animations that trigger as user scrolls
...
- InnoTech Hackathon - Green AI project
- LeetCode 1530 milestone
- CodeForces 50-day streak
- Certifications: MongoDB, AI, Data Science
- Timeline items appear sequentially as user scrolls
- Connecting line animates progressively
